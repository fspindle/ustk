...
#include <visp3/ustk_needle_detection3D/usNeedleTrackerSIR3D.h>
...
void usNeedleTrackerSIR3D::init(const usImagePostScan3D<unsigned char>& vol, double fov, unsigned int nPoints,
