...
usImage3D<double> usVolumeProcessing::getDerivativeFilterX(double sigma,
							  unsigned int size)
{
  if ((size % 2) != 1) {
...
usImage3D<double> usVolumeProcessing::getDerivativeFilterY(double sigma,
							  unsigned int size)
{
  if ((size % 2) != 1) {
...
usImage3D<double> usVolumeProcessing::getDerivativeFilterZ(double sigma,
							  unsigned int size)
{
  if ((size % 2) != 1) {
...
usImage3D<double> usVolumeProcessing::getDerivativeFilterXX(double sigma,
							   unsigned int size)
{
  if ((size % 2) != 1) {
...
usImage3D<double> usVolumeProcessing::getDerivativeFilterYY(double sigma,
							   unsigned int size)
{
  if ((size % 2) != 1) {
...
usImage3D<double> usVolumeProcessing::getDerivativeFilterZZ(double sigma,
							   unsigned int size)
{
  if ((size % 2) != 1) {
...
usImage3D<double> usVolumeProcessing::getDerivativeFilterXY(double sigma,
							   unsigned int size)
{
  if ((size % 2) != 1) {
...
usImage3D<double> usVolumeProcessing::getDerivativeFilterXZ(double sigma,
							   unsigned int size)
{
  if ((size % 2) != 1) {
...
usImage3D<double> usVolumeProcessing::getDerivativeFilterYZ(double sigma,
							   unsigned int size)
{
  if ((size % 2) != 1) {
    std::cerr << "Error: In usVolumeProcessing::getDerivativeFilterXZ(): "
...
void usVolumeProcessing::computeBarycenter(const usImage3D<unsigned char> &V,
