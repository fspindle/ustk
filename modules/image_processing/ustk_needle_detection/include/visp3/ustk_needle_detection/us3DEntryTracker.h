 ...
 */
 ...
 // permet de deteter le point d'entrée de l'aiguille dans l'image (on suppose que c'est l'intersection
 // de la courbe de l'aiguille avec un bord de l'image)

 // A RECODER

class us3DEntryTracker
{
 public:
  /**
   * Constructor.
