...
//#include <UsNeedleDetection/usNeedleDetectionConfig.h>
 ...
 */
 ...
 // Correspond à la modelisation du papier http://www.irisa.fr/lagadic/pdf/2013_icra_chatelain.pdf (equation 16)
 // H <-> m_model
 // a : position sur l'aiguille (0 : entrée, 1 : tip)


class us3DNeedleModel {
 public:
  /**
