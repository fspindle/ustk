...
public:
  ...
  static void convert(const usImagePreScan2D<unsigned char> * preScanImage,vtkSmartPointer<vtkImageData> &vtkPreScanImage, vtkSmartPointer<vtkImageImport> importer = NULL);
