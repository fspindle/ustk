...
public:
  ...
  static void convert(const usImagePostScan3D<unsigned int> &preScanImage,vtkSmartPointer<vtkImageData> &vtkPreScanImage, vtkSmartPointer<vtkImageImport> importer = NULL);
